...
data = {
    ...
    # 2. mfcc: 1곡(30초)에서 나온 5개의 조각(6초씩)을 저장
    "mfcc": [
        [[...], [...], ...], # 1번째 6초 구간의 258x13 행렬
        [[...], [...], ...], # 2번째 6초 구간의 258x13 행렬
        [[...], [...], ...], # 3번째 6초 구간의 258x13 행렬
        [[...], [...], ...], # 4번째 6초 구간의 258x13 행렬
        [[...], [...], ...]  # 5번째 6초 구간의 258x13 행렬
    ],

    # 3. labels: 위 5개 덩어리가 모두 'hiphop(인덱스 2번)'임을 기록
    "labels": [2, 2, 2, 2, 2] 
}
